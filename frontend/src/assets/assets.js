...
export const products = [
  {
    ...
    description: "A lightweight, usually knitted, pullover shirt, close",
    price: 100,
    image: [p_img1],
    category: "Women",
    subCategory: "Topwear",
  ...
  {
    _id: "eeeee",
    name: "Men Classic Formal Shirt",
    description: "A premium quality formal shirt for office wear.",
    price: 110,
    image: [p_img5],
    category: "Men",
    subCategory: "Shirts",
  ...
  },
  {
    ...
    description: "Comfortable and lightweight running shoes for all.",
    price: 200,
    image: [p_img6],
    category: "Unisex",
  ...
  {
    _id: "ggggg",
    name: "Kids Cartoon Printed Pajamas",
    description: "Soft and cozy pajamas set for kids with cute prints.",
    price: 90,
    image: [p_img7],
    category: "Kids",
